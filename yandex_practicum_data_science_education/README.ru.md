...
<!-- ! Думаю лучше сразу на страницу проекта для уменьшения количества кликов -->
1. [Предсказание оттока клиентов отеля](#hotel_customers_outflow_prediction)
...
<tbody>
  ...
  <tr id="">
    <td collspan="4"><a href="#beginning">🔼 НАВЕРХ</a></td>
  </tr>
  <tr id="git">
    <td>12</td>
